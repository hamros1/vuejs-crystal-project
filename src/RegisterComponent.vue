  ...
  <div class="h-screen text-white flex flex-col bg-hero-pattern">
	...
	<div class="space-y-3">
	  <label class="block relative space-y-1">
	    ...
	    <input class="shadow w-full bg-gray-50 border border-gray-200 text-black px-3 py-2 rounded focus:ring-2 focus:outline-none" value="">
	  </label>
	  <label class="block relative space-y-1">
	    <span class="mb-1 text-black">Password</span>
	    <input class="shadow w-full bg-gray-50 border border-gray-200 text-black px-3 py-2 rounded focus:ring-2 focus:outline-none" value="" type="password">
	  </label>
	  <label class="block relative space-y-1">
